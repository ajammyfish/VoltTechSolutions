    ...
    <div className="page">
        ...
        >
            <div className="wd-points">
                <ul>
                    ...
                    <li><span style={{color: 'blueviolet', fontWeight: 'bold', textDecoration: 'underline'}}>Search Engine Optimisation:</span> By implementing the most up to date on-page best SEO practices, I'll increase your websites ranking on search engines, driving more traffic to your business.</li>
                    <li><span style={{color: 'blueviolet', fontWeight: 'bold', textDecoration: 'underline'}}>Deep Customisation:</span> If you've got ideas, I want to hear them! I create deeply customisable, bespoke designs taylored to your industry and preferences.</li>
                    <li><span style={{color: 'blueviolet', fontWeight: 'bold', textDecoration: 'underline'}}>Ongoing Support and Maintenance:</span> I will continue to be of service to you after designing and deploying your website. If you wish to update the site in any way simply let me know and I'll get it done.</li>
        ...
        <div className="wd-prices">
            ...
            <div className="price-cards">
                <Price price={199} title={'Starter Tier'} description={<ul>
                ...
                <Price price={299} title={'Advanced Tier'} description={<ul>
                ...
                <Price price={399} title={'Pro Tier'} description={<ul>
